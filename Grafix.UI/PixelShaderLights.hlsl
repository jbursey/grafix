...
float4 main(VertexOutput input) : SV_TARGET
{
	...
	float4 spotDiffuseColor1 = CalculateSpotDiffuseLight(float4(0, 0, 1, 1), float4(200, 100, 10, 1), input.Normal, input.PositionWorld, 0.005);
	float4 spotDiffuseColor2 = CalculateSpotDiffuseLight(float4(0, 1, 0, 1), float4(10, 200, 200, 1), input.Normal, input.PositionWorld, 0.0075);
	float4 spotDiffuseColor3 = CalculateSpotDiffuseLight(float4(1, 0, 0, 1), float4(200, 200, 200, 1), input.Normal, input.PositionWorld, 0.0075);
